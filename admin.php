...
<head>
    ...
    <link rel="stylesheet" href="css/style-for-admin.css">
...
<div class="doing_in_form">
    <form class="admin-search-phone" method="GET" action="admin.php">
        ...
        <div class="search_for_phone">
            <input type="text" name="phone" id="phone" value="" placeholder="Вводите номер без +7 и 8' . htmlspecialchars($searchPhone) . '">
...
<script type="text/javascript">
    document.getElementById('download_excel_table').addEventListener('click', function() {
        window.location.href = 'bin/export_to_excel.php';
    });
</script>
</body>
</html>
