...
if ($max_id_prizes == $max_id_itog) {
    header("Location: bin/no-prizes.html");
    exit;
}
...
<div class="slider-container">
  ...
  <form class="" id="dataForm" action="add_data.php" method="POST">
    <div class="logo">
      <img src="img/logo_20.webp" alt="logo-gk-shans">
    </div>
  ...
  <div class="slide" id="slide2">
    <div class="wheel-bg shadow-for-wheel">
        ...
        <div class="deal-wheel">
            <img class=" shadow-for-wheel-elem" src="img/logo-for-whell.webp" alt="">
        <!-- блок с призами -->
        <ul class="spinner shadow-for-wheel-elem"></ul>
        <!-- язычок барабана -->
        <div class="ticker shadow-for-wheel-elem"></div>
        <!-- кнопка -->
        <form method="POST" action="bin/prize-output.php" style="display: contents;">
